...
import whyChoose from "../img/why-choose-us.jpg";
import OurMission from "../img/our-mission.jpg"
import OurVision from "../img/our-vision.jpg"
import aboutInner from "../img/about-inner.jpg"
function MainAbout() {
    return (
        <>
  ...
  <div className="container">
    ...
    <div className="col-lg-12 col-md-12 col-xs-12">
      <div className="row">
        <div className="col-lg-5 col-md-5 col-sm-12 col-xs-12 img-area"> <img className="img-area" src={aboutInner} alt="About" /> </div>
...
<section id="about-detail">
  <div className="container">
    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 mid-content">
      <div className="row">
        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 img-area"> <img src={whyChoose} alt="Why Choose Us" /> </div>
    ...
    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 mid-content">
      <div className="row row-reverse">
        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 img-area"> <img src={OurMission} alt="Our Mission" /> </div>
         <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 content-area">
          <div className="section_heading">
    ...
    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 mid-content">
      <div className="row">
        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 img-area"> <img src={OurVision} alt="Our Mission" /> </div>
        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 content-area">
          <div className="section_heading">
